      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-visible">
        {loading ? (
          ...
          <div className="p-12 text-center flex flex-col items-center">
            ...
            <h3 className="text-lg font-bold text-gray-800 mb-1">Nenhum produto cadastrado</h3>
            <p className="text-gray-500 text-sm mb-4">Cadastre produtos para adicioná-los rapidamente aos orçamentos.</p>
